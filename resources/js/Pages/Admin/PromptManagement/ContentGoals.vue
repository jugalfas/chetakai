...
<template>
    <Head title="Content Goals" />
    <AdminLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-foreground leading-tight">Content Goals</h2>
        </template>
        ...
        <DeleteConfirmationModal
            ...
            title="Delete Content Goal"
            message="Are you sure you want to delete this content goal? This action cannot be undone."
