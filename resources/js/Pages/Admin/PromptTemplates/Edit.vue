...
const form = useForm({
    ...
    platform_id: props.promptTemplate.platform_id ?? null,
    content_type_id: props.promptTemplate.content_type_id ?? null,
    prompt_template: props.promptTemplate.prompt_template,
    status: !!props.promptTemplate.status,
});
...
<template>
    <Head :title="`Edit: ${promptTemplate.name}`" />
    <AdminLayout>
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <h2 class="font-semibold text-xl text-foreground leading-tight">Edit Prompt Template</h2>
            </div>
        </template>
